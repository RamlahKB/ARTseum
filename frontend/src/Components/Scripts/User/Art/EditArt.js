...
class EditArt extends Component {
    ...
    render() {
        const {name, artist, year,catg , desc, err1, err2, err3, err4} = this.state;
                ...
                <div className="container-fluid mt-5 mb-5">
                    ...
                    <div className="row justify-content-center" data-aos="zoom-in-up">
                        <div className="col-md-4 card py-3 px-5 mb-5">
                            ...
                            <div className="form-group">
                                <select className="form-control form-control-sm" name="catg" value={catg} onChange={this.Handle}>
